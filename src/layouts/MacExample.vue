<template>
  <div class="q-pa-md">
    <div view="hHh LpR lfr" container style="height: 96vh" class="shadow-2 rounded-borders bg-grey-10">
      <q-header class="text-white shadow-4">
  ...
  <q-page-container class="bg-grey-10">
    ...
    <q-page-sticky position="top-right" :offset="[15, 15]">
        <q-btn class="text-white" padding="none" style="background-color: #212121dd; border-top-left-radius: 3px; border-top-right-radius: 3px;
