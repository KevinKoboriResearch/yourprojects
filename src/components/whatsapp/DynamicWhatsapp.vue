  ...
  <div>
    <q-page-sticky position="bottom-right" :offset="fabPos">
      <q-btn
        ...
        class="shadow-0 text-white" padding="none" style="border-top-left-radius: 50px; border-top-right-radius: 50px;
        border-bottom-left-radius: 0px; border-bottom-right-radius: 50px; border-style: solid; border-width: 2px;
        border-color:#ffffff00; background-color:#2eb82e00;"
      >
        <q-icon name="mdi-whatsapp" color="light-green-14" size="40px" />
        <!-- <img class="img-logo" :src="require('../../assets/whatsapp-logo.png')"> -->
      </q-btn>
    </q-page-sticky>
